...
// Data
const plants = [
  { name: "Holy Basil (Tulsi)", image: "../static/images/tulsi.jpeg", description: "The 'Queen of Herbs' known for its adaptogenic properties and stress relief.", properties: ["Adaptogen", "Immunity", "Stress Relief"] },
  { name: "Ashwagandha", image: "../static/images/ashwagandha.jpeg", description: "Ancient rejuvenating herb that helps combat stress and boost energy.", properties: ["Adaptogen", "Energy", "Anti-stress"] },
  { name: "Turmeric (Haldi)", image: "../static/images/turmeric.jpeg", description: "Powerful anti-inflammatory with numerous health benefits.", properties: ["Anti-inflammatory", "Antioxidant", "Digestive"] },
  { name: "Neem", image: "../static/images/neem.jpeg", description: "Purifying herb with antibacterial and blood-purifying properties.", properties: ["Antibacterial", "Skin Health", "Detox"] },
  { name: "Brahmi", image: "../static/images/brahmi.jpeg", description: "Cognitive enhancer that improves memory and brain function.", properties: ["Brain Health", "Memory", "Nervous System"] },
  { name: "Amla", image: "../static/images/amla.jpeg", description: "Rich in Vitamin C and powerful antioxidant properties.", properties: ["Immunity", "Anti-aging", "Digestive"] }
];
